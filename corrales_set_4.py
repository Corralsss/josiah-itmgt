...
def bin_to_dec(binary_string):
    ...
    for i in range(len(binary_string)): 
        result += int(binary_string[i]) * (2**((len(binary_string) - 1) - i))
...
def telephone_cipher(message):
    ...
    for i in range(len(message)):
        ...
        result += encoder_dict[message[i]]

        if i < len(message) - 1:
            if (encoder_dict[message[i]])[0] == (encoder_dict[message[i + 1]])[0]:
                result += "_"
...
def telephone_decipher(telephone_string):
    ...
    while counter != len(telephone_string):
        if counter != len(telephone_string) - 1:
            if telephone_string[counter] == telephone_string[counter + 1]:
                result += telephone_string[counter]
                counter += 1
            else:
                result += telephone_string[counter]
                if result == "_": 
                    ...
                    result_in_letter += decipher_dict[result]
                    result = ""
                telephone_string = telephone_string[counter + 1:]
                counter = 0 
        elif counter == len(telephone_string) - 1:
            result += telephone_string[counter]
            if result == "_": 
                result = "" 
            elif result != "_": 
